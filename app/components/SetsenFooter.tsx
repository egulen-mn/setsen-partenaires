        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="text-lg font-bold mb-2">
              <span className="text-[#c8102e]">Setsen</span> Partenaires
            </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <a href="https://setsen.fr" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-slate-400 hover:text-white transition">
                <QrCode size={13} /> setsen.fr
              </a>
              <a href="mailto:hello@setsen.fr" className="block text-slate-400 hover:text-white transition">hello@setsen.fr</a>
            </div>
          </div>
          <div>
